...
-- Tiempo de generación: 04-07-2023 a las 04:28:55
...
INSERT INTO `compras` (`id`, `cantidad`, `estado`, `created_at`, `updated_at`, `proveedor_id`) VALUES
(1, 10, 'P', '2023-06-28 12:13:45', NULL, 2),
(2, 30, 'C', '2023-07-03 10:31:14', NULL, 1),
(3, 110, 'C', '2023-07-03 10:56:07', NULL, 1),
(4, 10, 'P', '2023-07-03 11:15:43', NULL, 2),
(5, 8, 'P', '2023-07-03 11:27:21', NULL, 2),
(6, 8, 'P', '2023-07-03 11:35:40', NULL, 2),
(7, 6, 'P', '2023-07-03 11:40:20', NULL, 2),
(8, 3, 'P', '2023-07-03 11:47:37', NULL, 1);
...
INSERT INTO `detalle_compras` (`id`, `cantidad`, `estado`, `created_at`, `updated_at`, `compra_id`, `producto_id`) VALUES
(4, 3, 'P', '2023-07-03 11:47:37', NULL, 8, 1);
...
INSERT INTO `direcciones` (`id`, `barrio`, `direccion`, `piso`, `estado`, `created_at`, `updated_at`, `usuario_id`, `municipio_id`) VALUES
(1, 'Valle del cauca', 'N/A', 'N/A', '1', '2023-06-28 12:30:42', '2023-06-28 19:03:23', 1, 150);
...
INSERT INTO `informes` (`id`, `tipo`, `titulo`, `descripcion`, `imagen`, `estado`, `created_at`, `updated_at`, `usuario_id`) VALUES
(1, 'Prueba1', 'java', 'anuncio', '9c7355ae-5c7e-4f8e-abc7-ce4336681f17.jpg', '1', '2023-06-28 11:00:20', NULL, 1),
(2, 'anuncio', 'rebajas de fin de semana', 'este fin de semana de hasta el 50% de descuento en articulos  para la musica.', '6b6c9b69-b0d1-47ee-9f5f-5b8dbf1db810.jpg', '1', '2023-06-29 00:05:01', NULL, 1);
...
(100, 100, 'Sony ', NULL, '1', '2023-06-28 00:37:53', '2023-06-28 22:55:52'),
(102, 100, 'logitech', NULL, '1', '2023-06-28 21:39:44', NULL),
(103, 100, 'hp', NULL, '1', '2023-06-29 00:14:29', NULL),
(150, 101, 'diademas', NULL, '1', '2023-06-28 00:36:15', NULL),
(151, 101, 'unidades de almacenamiento', NULL, '1', '2023-06-28 21:09:38', NULL),
(152, 101, 'bosinas', NULL, '1', '2023-06-28 21:40:43', NULL),
(200, 102, 'azul', NULL, '1', '2023-06-27 22:56:52', NULL),
(201, 102, 'rojo', NULL, '1', '2023-06-28 00:30:51', NULL),
(202, 102, 'verde', NULL, '1', '2023-06-28 19:17:43', NULL);
...
(2, '1212121213', 'freddy', 'grueso', '3124567834', '1', '2023-06-28 00:00:00', NULL, NULL),
(3, '1111540697', 'Andres', 'Lopez', '3107030705', '1', '2023-06-28 00:00:00', NULL, NULL);
...
CREATE TABLE `productos` (
  ...
  `param_color` bigint(20) DEFAULT NULL,
  `param_categoria` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `productos` (`id`, `nombre_producto`, `precio_venta`, `iva`, `referencia`, `cantidad`, `imagen`, `descripcion`, `etiquetas`, `calificacion`, `descuento`, `estado`, `created_at`, `updated_at`, `param_marca`, `param_color`, `param_categoria`) VALUES
(1, 'dsfg', NULL, NULL, 'kjlhg', 3, NULL, NULL, NULL, NULL, NULL, '0', '2023-07-03 11:47:37', NULL, NULL, NULL, NULL);
...
INSERT INTO `proveedores` (`id`, `email`, `estado`, `created_at`, `updated_at`, `persona_id`) VALUES
(1, 'fregru@gmail.com', '1', '2023-06-28 00:00:00', NULL, 2),
(2, 'm4kjambyfavo@gmail.com', '1', '2023-06-28 00:00:00', NULL, 3);
...
ALTER TABLE `calificaciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Calificacion_Usuario1` (`usuario_id`),
  ADD KEY `fk_Calificacion_Productos1` (`producto_id`);
...
ALTER TABLE `carrusels`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Carrusel_Usuario1` (`usuario_id`);
...
ALTER TABLE `compras`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Pedidos_Proveedores1` (`proveedor_id`);
...
ALTER TABLE `departamentos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Departamentos_Paises1` (`pais_id`);
...
ALTER TABLE `detalle_compras`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Detalle_pedido_Productos1` (`producto_id`),
  ADD KEY `fk_Detalle_pedido_Pedidos1` (`compra_id`);
...
ALTER TABLE `detalle_ventas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_table1_Compra1` (`venta_id`),
  ADD KEY `fk_table1_Productos1` (`producto_id`);
...
ALTER TABLE `direcciones`
  ...
  ADD KEY `fk_Direccion_Municipios1` (`municipio_id`);
...
ALTER TABLE `informes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Informes_Usuario1` (`usuario_id`);
...
ALTER TABLE `lista_deseos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Deseos_Usuario1` (`usuario_id`),
  ADD KEY `fk_Deseos_Productos1` (`producto_id`);
...
ALTER TABLE `municipios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Municipios_Departamentos1` (`departamento_id`);
...
ALTER TABLE `parametros`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_parametro_tipo_parametro1` (`tp_id`),
  ADD KEY `fk_parametro_parametro1` (`foreign`);
...
ALTER TABLE `pqrs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_PQRSD_Usuario1` (`usuario_id`);
...
ALTER TABLE `productos`
  ...
  ADD KEY `fk_productos_parametro1` (`param_color`),
  ADD KEY `fk_productos_parametro2` (`param_categoria`),
  ADD KEY `param_marca` (`param_marca`);
...
ALTER TABLE `proveedores`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Proveedores_Persona1` (`persona_id`);

--
-- Indices de la tabla `tipo_parametros`
--
ALTER TABLE `tipo_parametros`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Usuario_Persona1` (`persona_id`);
...
ALTER TABLE `ventas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Productos_has_Usuario_Usuario1` (`usuario_id`),
  ADD KEY `fk_ventas_Direccion1` (`direccion_id`);
